...
export class A04OneDirective {
    ...
    @HostListener('click') onclick(): void {
        ...
        if (!this.inputElem) {
            ...
            this.render.setElementAttribute(this.inputElem, 'id', 'hello'); //@Input으로 받을 수 있는 값들 : hello, Hello~
            this.render.setElementAttribute(this.inputElem, 'value', 'Hello~');

            // Class 속성 지정
            this.render.setElementClass(this.inputElem, 'form-control', true); //true적용 / false 미적용
    ...
    template: `
        <div class="panel panel-default">
            ...
            <div class="panel panel-body">
               <div a04OneDir>Inner Content</div>
